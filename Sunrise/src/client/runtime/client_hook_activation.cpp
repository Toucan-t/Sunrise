...
[[nodiscard]] bool activate_required_main_locked() noexcept {
    ...
    // Steam init attaches this before base-generation package registration. Keep the install here
    // as an idempotent ownership check for the normal main-image activation path.
    ...
    // These are optional feature hooks. A signature miss is reported by that feature and does not
    // demote the base Sunrise boot path.
