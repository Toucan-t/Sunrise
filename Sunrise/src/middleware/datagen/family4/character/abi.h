...
/** Opaque inventory-change prefix begins immediately after the 350 inventory rows. */
inline constexpr std::size_t kInventoryChangeUnknownOffset = 11256;
/** Native transient inventory-change list begins at byte 11,260. */
inline constexpr std::size_t kInventoryChangesOffset = 11260;
/** Equipped instance SOIDs begin after the transient inventory-change bank at byte 11,456. */
...
static_assert(offsetof(layout::Object, inventoryChanges) == kInventoryChangesOffset);
